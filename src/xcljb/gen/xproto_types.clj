...
(def BOOL (xcljb.gen-common/->PrimitiveType :ubyte))
...
(clojure.core/defrecord
 ...
 (sizeof [this] (clojure.core/+ (.sizeof CARD8) (.sizeof CARD8)))
 xcljb.gen-common/Serializable
 (to-frame [this] [(.to-frame CARD8) (.to-frame CARD8)])
...
(clojure.core/defrecord
 ...
 [x y]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ (.sizeof INT16) (.sizeof INT16)))
 xcljb.gen-common/Serializable
 (to-frame [this] [(.to-frame INT16) (.to-frame INT16)])
...
(clojure.core/defrecord
 ...
 (sizeof
  [this]
  (clojure.core/+ (.sizeof CARD8) (.sizeof CARD8) (.sizeof CARD8) 5))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [(.to-frame CARD8)
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   ...
   (clojure.core/reduce
    (clojure.core/fn
     [x__858__auto__ y__859__auto__]
     (clojure.core/+ x__858__auto__ (.sizeof y__859__auto__)))
    0
    (:visuals this))))
 xcljb.gen-common/Serializable
 (to-frame
  ...
  [(.to-frame CARD8)
   ...
   (clojure.core/repeat 4 :byte)
   (clojure.core/map
    (fn* [p1__862__863__auto__] (.to-frame p1__862__863__auto__))
    (:visuals this))])
 (to-value
  [this]
  [(:depth this)
   ...
   (clojure.core/repeat 4 0)
   (clojure.core/map
    (fn* [p1__864__865__auto__] (.to-value p1__864__865__auto__))
    (:visuals this))]))
...
(clojure.core/defrecord
 ...
 (to-frame
  ...
  [(.to-frame CARD8)
   ...
   (clojure.core/repeat
    (clojure.core/count (:authorization_protocol_name this))
    (.to-frame char))
   (clojure.core/repeat
    (clojure.core/count (:authorization_protocol_data this))
    (.to-frame char))])
 (to-value
  [this]
  [(:byte-order this)
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   ...
   (.sizeof KEYCODE)
   4
   (clojure.core/* (.sizeof char) (clojure.core/count (:vendor this)))
   (clojure.core/reduce
    (clojure.core/fn
     [x__858__auto__ y__859__auto__]
     (clojure.core/+ x__858__auto__ (.sizeof y__859__auto__)))
...
(clojure.core/defrecord
 ...
 (sizeof
  [this]
  (clojure.core/+ (.sizeof TIMESTAMP) (.sizeof INT16) (.sizeof INT16)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [(.to-frame TIMESTAMP) (.to-frame INT16) (.to-frame INT16)])
...
(clojure.core/defrecord
 ...
 [name value]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ (.sizeof ATOM) (.sizeof CARD32)))
 xcljb.gen-common/Serializable
 (to-frame [this] [(.to-frame ATOM) (.to-frame CARD32)])
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   (.sizeof CARD8)
   (clojure.core/* (.sizeof char) (clojure.core/count (:name this)))))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [(.to-frame CARD8)
...
(clojure.core/defrecord
 ...
 [opcode window]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof WINDOW)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode mode window]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 (.sizeof BYTE) (.sizeof WINDOW)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 (.sizeof CARD8) (.sizeof WINDOW)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode drawable]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof DRAWABLE)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode atom]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof ATOM)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   ...
   3
   (.sizeof CARD32)
   (clojure.core/* (.sizeof void) (clojure.core/count (:data this)))))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof WINDOW) (.sizeof ATOM)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   ...
   (.sizeof WINDOW)
   (.sizeof CARD32)
   (clojure.core/* (.sizeof char) (clojure.core/count (:event this)))))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode time]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof TIMESTAMP)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode mode time]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 (.sizeof CARD8) (.sizeof TIMESTAMP)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode font]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof FONT)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode font]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof FONTABLE)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode pixmap]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof PIXMAP)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode gc]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof GCONTEXT)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   ...
   (.sizeof CARD8)
   2
   (clojure.core/* (.sizeof BYTE) (clojure.core/count (:data this)))))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   ...
   (.sizeof INT16)
   (.sizeof INT16)
   (clojure.core/* (.sizeof BYTE) (clojure.core/count (:items this)))))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode cmap]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof COLORMAP)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 (sizeof
  [this]
  (clojure.core/+ 3 1 (.sizeof COLORMAP) (.sizeof COLORMAP)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode cursor]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof CURSOR)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode percent]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 (.sizeof INT8)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode mode]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 (.sizeof CARD8)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 [opcode resource]
 xcljb.gen-common/Measurable
 (sizeof [this] (clojure.core/+ 3 1 (.sizeof CARD32)))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   ...
   (.sizeof CARD16)
   (.sizeof INT16)
   (clojure.core/* (.sizeof ATOM) (clojure.core/count (:atoms this)))))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
...
(clojure.core/defrecord
 ...
 (sizeof
  ...
  (clojure.core/+
   3
   (.sizeof CARD8)
   (clojure.core/* (.sizeof CARD8) (clojure.core/count (:map this)))))
 xcljb.gen-common/Serializable
 (to-frame
  [this]
  [:ubyte
